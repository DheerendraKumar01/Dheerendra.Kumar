package com.Assessment_18_Sep_2021_Collection;
...
public class TestPatientList {
	...
	public static void main(String args[]) {
		...
		for (Patient patient : patientList) {
			System.out.println("Patient id : " + patient.getPatientId() + ", Patient name : " + patient.getName()
		...
		while (iterator.hasNext()) {
			...
			System.out.println("Patient id : " + p.getPatientId() + ", Patient name : " + p.getName()
		...
		for (Patient patient1 : listofpatientintreeset) {
			System.out.println("Patient id : " + patient1.getPatientId() + ", Patient name : " + patient1.getName()
					+ ", Patient age : " + patient1.getAge());
		}
